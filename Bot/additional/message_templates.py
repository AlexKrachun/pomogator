...
''',
        ...
        'subscribe_plan': """Стоимость генерирования:

- Для каждой генерации модели требуется определенное количество внутренней валюты, например для GPT-4o - 5 единиц.

Уровни подписок:

Подписка действует 28 календарных дней. Каждые 7 дней пользователю начисляется определенное количество единиц внутренней валюты (фантики).
