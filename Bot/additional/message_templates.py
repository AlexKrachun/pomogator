...
валюта за которую мы оплачиваем запросы в нейросети: 🍬
...
Рабочие лошадки. Не дорогие и умные:
    🤖 `gpt-4o` - умная, быстрая, не думающая
    🤖 `o3-mini` - умная, размышляет перед ответом, работает довольно долго
    🤖 `gpt-4o-search-preview` - умная, быстрая, умеет искать в интернете

Для сложных задачь. Дорогие и очень умные
    🤖 `claude 3.7-sonnet` - умная, быстрая, не очень дорогая
    🤖 `o1` - умная, очень хорошо размышляет перед ответом, долгая
    🤖 `gpt-4.5-preview` - очень умная, быстрая и просто неприлично дорогая
