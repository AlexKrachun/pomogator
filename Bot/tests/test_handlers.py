...
def mock_message():
    ...
    message.from_user = MagicMock(id=123, username="test_user", first_name="Test", last_name="User", last_used_model='test_model')
...
#     await start_cmd(mock_message, state=None)
