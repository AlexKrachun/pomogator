message_templates = {
    ...
    'ru': {
        ...
        'help': 'Вы можете взаимодействовать с этим ботом с помощью команд вроде /start, /profile и /help.',        'language_confirmation': "Язык был изменен на русский.",
    ...
    'ua': {
        'start': "Привіт, я не використовую API GPT-4 (ChatGPT). Введіть /help",
