...
def test_get_user_by_tg_id(test_db):
    test_db.add_user(name='test_name', tg_id=54321)
...
def test_update_site_id_by_tg_id(test_db):
    test_db.add_user(name='test_name', tg_id=44444, site_id=0)
...
def test_update_sub_status_by_tg_id(test_db):
    test_db.add_user(name='test_name', sub_status='free', tg_id=33333)
...
def test_update_token_has_by_tg_id(test_db):
    test_db.add_user(name='test_name', token_has=100, tg_id=66666)
...
def test_get_sub_status_by_tg_id(test_db):
    test_db.add_user(name='test_name', sub_status='free', tg_id=12345)
...
def test_get_token_has_by_tg_id(test_db):
    test_db.add_user(name='test_name', token_has=1500, tg_id=11111)
...
def test_set_current_context_by_tg_id(test_db):
    test_db.add_user(name='context_user', tg_id=2222)
...
def test_get_current_context_by_tg_id(test_db):
    test_db.add_user(name='context_user2', tg_id=3333)
...
def test_user_has_empty_curr_context_by_tg_id(test_db):
    test_db.add_user(name='empty_context_user', tg_id=4444)
    ...
    test_db.add_message(chat_id, 'user', 'Hello')
    assert test_db.user_has_empty_curr_context_by_tg_id(4444) is False


def test_add_message(test_db):
    test_db.add_user(name='msg_user', tg_id=5555)
    chat_id = test_db.create_new_context_by_tg_id(5555)
    test_db.add_message(chat_id, 'assistant', 'Hello from the assistant')
...
def test_update_dialog_neame(test_db):
    test_db.add_user(name='rename_dialog_user', tg_id=6666)
    chat_id = test_db.create_new_context_by_tg_id(6666)
    test_db.set_current_context_by_tg_id(tg_id=6666, another_context_id=chat_id)
...
def test_get_user_by_tg_id_again(test_db):
    test_db.add_user(name='get_user_test', tg_id=8888)
...
def test_get_full_dialog(test_db):
    test_db.add_user(name='dialog_user', tg_id=1010)
    chat_id = test_db.create_new_context_by_tg_id(1010)
    test_db.add_message(chat_id, 'user', 'Hello')
    test_db.add_message(chat_id, 'assistant', 'Hi, how can I help?')
...
def test_make_context_history(test_db):
    test_db.add_user(name='history_user', tg_id=2020)
    chat_id = test_db.create_new_context_by_tg_id(2020)
    test_db.add_message(chat_id, 'user', 'User message')
    test_db.add_message(chat_id, 'assistant', 'Assistant reply')
...
def test_from_context_id_get_topic(test_db):
    test_db.add_user(name='topic_user', tg_id=3030)
...
def test_get_users_contexts_by_tg_id(test_db):
    test_db.add_user(name='multi_chat_user', tg_id=4040)
